...
\title{Research progress \today}
% \titlerunning{Research progress \today}
\author{\usebox{\MyName} (King-Yin Yan)
% \\ \footnotesize{General.Intelligence@Gmail.com}
}
\date{\today}	% does not fucking work
...
\begin{equation}
\includegraphics[scale=0.3]{basic-architecture.jpg}
\end{equation}
where I use the symbol $\NN$ for a neural network.

The mental state is a vector $\vect{x}$ which should possess a logical structure:
\begin{equation}
\includegraphics[scale=0.3]{logical-structure.jpg}
\end{equation}
