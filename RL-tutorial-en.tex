...
When you hear reinforcement learning, it should invoke an imagery in your mind of a little critter such as this cockroach: $\vcenter{\hbox{\includegraphics[scale=0.2]{cockroach.png}}}$
